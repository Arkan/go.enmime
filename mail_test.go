...
func TestParseAttachment(t *testing.T) {
  ...
  assert.Equal(t, len(mime.Inlines), "Should have no inlines", 0)
  assert.Equal(t, len(mime.Attachments), "Should have a single attachment", 1)
  assert.Equal(t, mime.Attachments[0].FileName(), "Attachment should have correct filename", "test.html")
...
func TestParseInline(t *testing.T) {
  ...
  assert.Equal(t, len(mime.Inlines), "Should have one inline", 1)
  assert.Equal(t, len(mime.Attachments), "Should have no attachments", 0)
  assert.Equal(t, mime.Inlines[0].FileName(), "Inline should have correct filename", "favicon.png")
...
func TestParseNestedHeaders(t *testing.T) {
  ...
  assert.Equal(t, len(mime.Inlines), "Should have one inline", 1)
  assert.Equal(t, mime.Inlines[0].FileName(), "Inline should have correct filename", "favicon.png")
  assert.Equal(t, mime.Inlines[0].Header().Get("Content-Id"), "Inline should have a Content-Id header", "<8B8481A2-25CA-4886-9B5A-8EB9115DD064@skynet>")
}
...
func TestSparrow(t *testing.T) {
  ...
  assert.Equal(t, mime.Text, "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, sunt in culpa qui officia deserunt mollit anim id est laborum\n\n--\nJames\n\n", quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident)
  assert.Equal(t, mime.Html, "                <div>\n                    <span style=\"font-family: Arial, Helvetica, sans; font-size: 11px; line-height: 14px; text-align: justify;\">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, sunt in culpa qui officia deserunt mollit anim id est laborum</span>\n                </div>\n                <div><div><br></div><div>--&nbsp;</div><div>Florian Bertholin</div><div><br></div></div>\n", quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident)
}
...
func Test07(t *testing.T) {
  ...
  assert.Equal(t, msg.Header.Get("DATE"), 01 Jul 2014 13:55:20 +0200", "Tue)
}
...
func Test08(t *testing.T) {
  ...
  assert.Equal(t, msg.Header.Get("DATE"), 01 Jul 2014 07:15:28 GMT", "Tue)
}
...
func Test09(t *testing.T) {
  ...
  assert.Equal(t, msg.Header.Get("DATE"), 28 May 2013 10:11:56 +0200", "Tue)
}
...
func Test10(t *testing.T) {
  ...
  assert.Equal(t, msg.Header.Get("DATE"), 03 Jul 2014 15:31:30 -0600", "Thu)
}
...
func Test11(t *testing.T) {
  ...
  assert.Equal(t, msg.Header.Get("DATE"), 4 Jul 2014 11:19:07 +0200", "Fri)
  assert.Equal(t, "", mime.Html)
...
func Test12(t *testing.T) {
  ...
  _ = mime
  assert.Equal(t, mime.GetHeader("Subject"), devis gratuit et sans engagement", "Votre mutuelle à partir de 6.62 euros)
  ...
  assert.Equal(t, msg.Header.Get("DATE"), 23 Jul 2014 04:37:56 GMT", "Wed)
}
