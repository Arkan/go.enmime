...
func TestMessageIdWithMessageId(t *testing.T) {
  msg := readMessage("16-latin_1_text_body.eml")
  mime, err := ParseMIMEBody(msg)
  if err != nil {
    t.Fatalf("Failed to parse non-MIME: %v", err)
  }
  assert.Equal(t, "<5416B823.9040204@skiset.com>", mime.MessageId())
}

func TestMessageIdWithoutMessageId(t *testing.T) {
  msg := readMessage("07-no_message_id.eml")
  mime, err := ParseMIMEBody(msg)
  if err != nil {
    t.Fatalf("Failed to parse non-MIME: %v", err)
  }
  assert.Equal(t, "<1a9bf3ad2ada1b4df37ba5d25388b746b77fbc8e7c50ee929379d7f1394877d3-auto-generated@revapost.com>", mime.MessageId())
}
